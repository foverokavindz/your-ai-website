    ...
    >
      ...
      <Container className="relative z-10 w-full max-w-4xl mx-auto px-4 sm:px-6 flex flex-col items-center justify-center text-center">
        ...
        <motion.div
          ...
          className="inline-flex items-center gap-2 text-base font-medium mb-8"
          style={{ color: '#888888' }}
        >
        ...
        <motion.p
          ...
          className="text-lg sm:text-xl leading-relaxed max-w-2xl mb-10 font-medium"
          style={{ color: '#444444' }}
        >
        ...
        >
          <button
            className="group w-full sm:w-auto inline-flex items-center justify-center gap-2 px-8 py-3.5 text-sm sm:text-base font-medium rounded-full transition-all duration-200 shadow-sm hover:shadow-md"
          ...
          <a
            ...
            onMouseEnter={e => { e.currentTarget.style.backgroundColor = '#E0E0E0'; e.currentTarget.style.borderColor = '#1A1A1A'; }}
